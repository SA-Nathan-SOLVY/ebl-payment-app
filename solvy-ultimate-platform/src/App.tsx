...
import GUAPCOIN from './components/GUAPCOIN'
import AESInvestment from './components/AESInvestment'
      ...
      <Router>
        <div className="min-h-screen bg-gradient-to-br from-slate-900 via-blue-900 to-slate-800">
          ...
          <Routes>
            ...
            <Route path="/ebl" element={<EBLPayment currentUser={currentUser} />} />
            
            {/* SOLVY Card Management */}
            <Route path="/card" element={<SolvyCard currentUser={currentUser} />} />
            
            {/* SOVEREIGNITITY™ - Core Innovation */}
            <Route path="/sovereignitity" element={<SOVEREIGNITITY currentUser={currentUser} />} />
            
            {/* GUAPCOIN - Blockchain Bridge */}
            <Route path="/guapcoin" element={<GUAPCOIN currentUser={currentUser} />} />
            
            {/* AES Investment - African Connection */}
            <Route path="/aes" element={<AESInvestment currentUser={currentUser} />} />

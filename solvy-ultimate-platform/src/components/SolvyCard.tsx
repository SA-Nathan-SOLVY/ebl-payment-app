            ...
            <div className="text-center lg:text-left">
              ...
              >
                ...
                <p className="text-xl text-gray-300 mb-8">
                  ...
                  Earn GUAPCOIN rewards, track your SOVEREIGNITITY™ score, and take control 
        ...
        >
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
            ...
            <div className="bg-white/10 backdrop-blur-sm rounded-xl p-6 border border-white/20">
              ...
              <p className="text-gray-300 mt-4">
                Access the complete SOLVY ecosystem: Education, GUAPCOIN, Reign products, 
                MAN Network security, and AES Investment opportunities - all in one platform.
              </p>
            </div>
          </div>
        </motion.div>
                ...
                <div>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                    ...
                    <div className="bg-green-600/20 rounded-lg p-6">
                      <h4 className="text-lg font-semibold text-white mb-2">GUAPCOIN Balance</h4>
                ...
                <div>
                  ...
                  <div className="space-y-4">
                    {[
                      ...
                      { merchant: 'GUAPCOIN Reward', amount: +12.50, date: '2024-08-22', type: 'Reward' },

        ...
        >
          ...
          <div className="mt-6">
            <a
              ...
              className="inline-flex items-center px-6 py-3 bg-gradient-to-r from-pink-600 to-purple-600 text-white font-semibold rounded-lg hover:from-pink-500 hover:to-purple-500 transition-all duration-300"
            >
                ...
                {reignProducts.map((product, index) => (
                  <div key={index} className="p-6 bg-gradient-to-r from-pink-500/20 to-purple-500/20 border border-pink-500/30 rounded-lg hover:from-pink-500/30 hover:to-purple-500/30 transition-all duration-300">
                    ...
                    <div className="flex justify-between items-center">
                      ...
                      <button className="px-4 py-2 bg-pink-600 text-white rounded-lg hover:bg-pink-500 transition-colors text-sm">
                        Order via EBL
                      </button>
                    </div>
                  </div>
                  ...
                  <div className="p-6 bg-gradient-to-r from-purple-500/20 to-pink-500/20 border border-purple-500/30 rounded-lg">
                    ...
                    <ul className="text-gray-300 space-y-3">
                      ...
                      <li className="flex items-start">
                        ...
                        <div>
                          <strong className="text-white">GUAPCOIN Rewards:</strong> Earn blockchain rewards on every Reign purchase
                        </div>
                      </li>
                      <li className="flex items-start">
                  ...
                  <div className="p-6 bg-green-500/20 border border-green-500/30 rounded-lg">
                    ...
                    <div className="space-y-3">
                      ...
                      <div className="flex items-center">
                        ...
                        <span className="text-gray-300">Earn GUAPCOIN rewards automatically</span>
                      </div>
                    </div>
                  </div>
                </div>

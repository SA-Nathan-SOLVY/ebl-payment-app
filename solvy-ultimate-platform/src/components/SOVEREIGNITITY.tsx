...
const SOVEREIGNITITY: React.FC<SOVEREIGNITITYProps> = ({ currentUser }) => {
  ...
  const steps = [
    ...
    },
    {
      ...
      description: 'Connect to GUAPCOIN and AES Investment opportunities'
    }
  ]
      ...
      <div className="mx-auto max-w-6xl">
        ...
        >
          ...
          <p className="text-lg text-gray-300 max-w-3xl mx-auto">
            ...
            and connect to global African diaspora development through GUAPCOIN and AES Investment Bank.
          </p>
        </motion.div>
                ...
                <div className="space-y-6">
                  ...
                  <div className="p-6 bg-green-500/20 border border-green-500/30 rounded-lg">
                    ...
                    <ul className="text-gray-300 space-y-2">
                      ...
                      <li>• <strong>You connect</strong> to African development through GUAPCOIN</li>
                ...
                <div className="space-y-6">
                  <div className="p-6 bg-blue-500/20 border border-blue-500/30 rounded-lg">
                    ...
                    <ul className="text-gray-300 space-y-2">
                      ...
                      <li className="flex items-center">
                        <CheckCircle className="h-5 w-5 text-green-400 mr-2" />
                        GUAPCOIN earning potential
                      </li>
                      <li className="flex items-center">
                        <CheckCircle className="h-5 w-5 text-green-400 mr-2" />
                        AES Investment access
                      </li>
                      <li className="flex items-center">
                        <CheckCircle className="h-5 w-5 text-green-400 mr-2" />
                  ...
                  <div className="p-6 bg-green-500/20 border border-green-500/30 rounded-lg">
                    ...
                    <ul className="text-gray-300 space-y-3">
                      <li className="flex items-start">
                        ...
                        <div>
                          <strong>Transaction Participation:</strong> Earn GUAPCOIN for every SOLVY card transaction
                        </div>
                      </li>
                      <li className="flex items-start">
                      ...
                      <li className="flex items-start">
                        ...
                        <div>
                          <strong>AES Investment:</strong> Earn returns from African development projects
                        </div>
                      </li>
                    </ul>
                  </div>
                ...
                <div className="space-y-6">
                  ...
                  <div className="grid grid-cols-2 gap-4">
                    <div className="p-4 bg-white/5 rounded-lg text-center">
                      ...
                      <div className="text-xl font-bold text-white">GUAPCOIN</div>
            ...
            <div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
                ...
                <div className="p-6 bg-yellow-500/20 border border-yellow-500/30 rounded-lg text-center">
                  ...
                  <h5 className="text-xl font-semibold text-white mb-2">GUAPCOIN Active</h5>
              ...
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 mb-8">
                <div className="p-6 bg-blue-500/20 border border-blue-500/30 rounded-lg">
                  ...
                  <ul className="text-gray-300 space-y-3">
                    ...
                    <li className="flex items-center">
                      <ArrowRight className="h-5 w-5 text-blue-400 mr-2" />
                      Explore GUAPCOIN earning opportunities
                    </li>
                    <li className="flex items-center">
                      <ArrowRight className="h-5 w-5 text-blue-400 mr-2" />
                      Learn about AES Investment Bank partnerships
                    </li>
                    <li className="flex items-center">
                      <ArrowRight className="h-5 w-5 text-blue-400 mr-2" />
